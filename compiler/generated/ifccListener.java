...
public interface ifccListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ifccParser#var_ass}.
	 * @param ctx the parse tree
	 */
	void enterVar_ass(ifccParser.Var_assContext ctx);
	/**
	 * Exit a parse tree produced by {@link ifccParser#var_ass}.
	 * @param ctx the parse tree
	 */
	void exitVar_ass(ifccParser.Var_assContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code Unaire}
	 * labeled alternative in {@link ifccParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterUnaire(ifccParser.UnaireContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Unaire}
	 * labeled alternative in {@link ifccParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitUnaire(ifccParser.UnaireContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterParExpr(ifccParser.ParExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ParExpr}
	 * labeled alternative in {@link ifccParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitParExpr(ifccParser.ParExprContext ctx);
	/**
