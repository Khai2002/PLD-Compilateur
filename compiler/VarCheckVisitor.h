...
{
public:
        VarCheckVisitor() : cur_pointer(0), number_warnings(0) {}
        VarCheckVisitor(unordered_map<string, VariableInfo> adrTable) : adrTable(adrTable), cur_pointer(0), number_warnings(0) {}
