...
antlrcpp::Any CodeGenVisitor::visitAddSubExpr(ifccParser::AddSubExprContext *ctx)
{
    ...
    cout << "    movl "; visit(left); cout << ", %edx\n";

    cout << "    movl "; visit(right); cout << ", %eax\n";
...
antlrcpp::Any CodeGenVisitor::visitMultDivModExpr(ifccParser::MultDivModExprContext *ctx) 
{
    ...
    cout << "    movl "; visit(left); cout << ", %eax\n";

    if(op == "*"){
        cout << "    imull "; visit(right); cout << ", %eax\n";
    }else {
        cout << "    cltd" << endl;
        cout << "    idivl "; visit(right); cout << "\n";
        cout << "    movl "; 
        if(op == "/") {
